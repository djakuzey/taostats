...
function Table<TableData>({
  ...
  const headerRow = table.getHeaderGroups().map((headerGroup) => (
  ...
  const footer = table.getFooterGroups().map((footerGroup) => (
  ...
  return (
    <div className={cn(className)}>
      {title && (
        <h1 className="text-[20px] font-medium text-white mb-12">{title}</h1>
      )}
      <div
        className="grid"
        style={{
