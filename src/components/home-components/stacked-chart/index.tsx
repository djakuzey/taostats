...
const StackedChart = ({ className }: ChartTradingViewProps) => {
  ...
  return (
    <div className={cn('w-full', className)} ref={ref}>
      <div className="text-[20px] font-medium text-white">Staked Issuance</div>
      <div className="relative">
        <div className="flex flex-col absolute">
          <div className="text-[36px] text-white mb-3">6,246,404τ</div>
