...
export const validators: Validator[] = [
  ...
  { name: 'Item 10', total: 87.9, owner: 'William Anderson', network: 37.11 },
  ...
  { name: 'Item 13', total: 18.9, owner: 'Emily Lopez', network: 94.02 },
  {
    name: 'Item 14',
    total: 75.43,
    owner: 'Alexander Gonzalez',
    network: 23.46,
  },
  { name: 'Item 15', total: 39.56, owner: 'Mia Perez', network: 69.88 },
  { name: 'Item 16', total: 52.78, owner: 'Ethan Carter', network: 45.32 },
  { name: 'Item 17', total: 28.9, owner: 'Abigail Flores', network: 11.67 },
  {
    name: 'Item 18',
    total: 81.23,
    owner: 'Isabella Washington',
    network: 78.9,
  },
